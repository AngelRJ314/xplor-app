      ...
      <View>
        <View style={style.logocontainer}>
          ...
          <Pressable> 
            ...
            <Image source={require("@/assets/images/beglogo.png")} style={style.homeimage}/> 
            ...
            horizontal>
               ...
               <Pressable style={style.fcontainer}>
                  <Text style={style.text}> Food </Text>
               </Pressable>
               <Pressable style={style.hcontainer}>
                  <Text style={style.text}> History </Text>
               </Pressable>
               <Pressable style={style.acontainer}>
        ...
        <ScrollView style={style.scroll}> 
          ...
          <Pressable onPress={onPressFunctionReserve} style={style.thereservecontainer}>
            <Image source={"https://images.squarespace-cdn.com/content/v1/58d2c08f725e25221a206ef3/1583285753191-T3MFQ3RKSR1L2I73YQVQ/the-reserve_21743836568_o.jpg"} style={style.thereserve}/>
          </Pressable>
          ...
          <Pressable onPress={onPressFunctionPark} style={style.parkcontainer}>
            <Image source={"https://farm8.staticflickr.com/7027/6534189599_6d7f9f6c8b_z.jpg"} style={style.park}/>
          </Pressable>
          ...
          <Pressable onPress={onPressFunctionMusic} style={style.musiccontainer}>
            <Image source={"https://www.musiccenter.org/media/intjb04g/mtf.jpeg?anchor=center&mode=crop&width=1920&height=1080&rnd=132815648649270000"} style={style.music}/>
          </Pressable>
          <Pressable onPress={onPressFunctionMaple} style={style.maplecontainer}>
            <Image source={"https://images1.loopnet.com/i2/x8wwn4HHearLbJ2DDj0kbzSIdVYiDVHGHUI_kjRXumk/110/401-E-12th-St-Los-Angeles-CA-401-E-12th-St-1-Large.jpg"} style={style.maple}/>
          </Pressable> 
          <Pressable onPress={onPressFunctionFlowers} style={style.flowercontainer}>
            <Image source={"https://lh3.googleusercontent.com/p/AF1QipPte9Zh6dLy7_ZhVxPlPveeOJ80VhPnq9FsCH_A=s1360-w1360-h1020"} style={style.flower}/>
          </Pressable> 
      </ScrollView>
    </View>
  )
